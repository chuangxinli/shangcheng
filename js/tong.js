...
$(".btn-p").click(function(){
	...
	if($(".txt1").val()!=""&&$(".txt2").val()!=""&&($(".txt1").val()!=$(".txt2").val())&&$(".txt1").val().length<8&&$(".txt2").val().length<8){
		...
		getdatabypricequjian(smallnum,bignum,"童装");
	}
});
$(".leibie li a").click(function(){
	...
	if(length==2){
		...
		getdata3("童装",arg1,arg2);
	}
	if(length==3){
		var arg1=$($(".d-ci")[0]).html();
		var arg2=$($(".d-ci")[1]).html();
		var arg3=$($(".d-ci")[2]).html();
		getdata4("童装",arg1,arg2,arg3);
	}
	if(length==4){
		var arg1=$($(".d-ci")[0]).html();
		var arg2=$($(".d-ci")[1]).html();
		...
		getdata5("童装",arg1,arg2,arg3,arg4);
	}
	if(length==5){
		var arg1=$($(".d-ci")[0]).html();
		var arg2=$($(".d-ci")[1]).html();
		...
		getdata6("童装",arg1,arg2,arg3,arg4,arg5);
	}
});
